...
public class Grafico2D extends Canvas
{
	...
	Grafico2D()
	{
		...
		/*Rectangulo*/
		fPuntoX[0]=-2;  fPuntoY[0]=2;   fPuntoZ[0]=-0;
		fPuntoX[1]=2;   fPuntoY[1]=2;   fPuntoZ[1]=-0;
		fPuntoX[2]=2; 	fPuntoY[2]=-5;  fPuntoZ[2]=-0;
		fPuntoX[3]=-2;  fPuntoY[3]=-5;  fPuntoZ[3]=-0;

		fPuntoX[4]=-2;  fPuntoY[4]=2;   fPuntoZ[4]=0;
		fPuntoX[5]=2;   fPuntoY[5]=2;   fPuntoZ[5]=0;
		fPuntoX[6]=2;   fPuntoY[6]=-5;  fPuntoZ[6]=0;
		fPuntoX[7]=-2;  fPuntoY[7]=-5;  fPuntoZ[7]=0;

		/*Triangulo 1*/
		fPuntoX[8]=-2;  fPuntoY[8]=2;   fPuntoZ[8]=-0;
		fPuntoX[9]=2;   fPuntoY[9]=2;   fPuntoZ[9]=-0;
		...
		fPuntoX[14]=2;  fPuntoY[14]=2;  fPuntoZ[14]=0;
		fPuntoX[15]=2;  fPuntoY[15]=2;  fPuntoZ[15]=0;

		/*Triangulo 2*/
		fPuntoX[16]=-2; fPuntoY[16]=-5;  fPuntoZ[16]=-0;
		fPuntoX[17]=2;  fPuntoY[17]=-5;  fPuntoZ[17]=-0;
		...
		fPuntoX[22]=2;  fPuntoY[22]=-5;  fPuntoZ[22]=0;
		fPuntoX[23]=-2;  fPuntoY[23]=-5;   fPuntoZ[23]=0;
