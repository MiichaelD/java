...
public class Number2TextSpanish{
	...
	public static void main(String[] args) {
		...
		do{
			System.out.println("¿Que numero?\n1)INTRODUCIR\t2)AZAR\t3)SALIR");
			op=in.nextInt();
			l.numero="";
			switch(op){
				case 1: System.out.println("¿Que numero?");
				i=Double.parseDouble(in.next());
				l.particion(i);
				System.out.println("el numero "+i+" es el:\n"+l.numero);break;
	...
	public String metodoEntero(int entero){
		...
		do{
			...
			else if(num>=1000&&num<10000){menores(1000); numero+=" mil ";}
